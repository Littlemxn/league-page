/*   STEP 1   */
export const leagueID = "1048420127257108480"; // your league ID
...
export const managers = [
    ...
    },
  {
      ...
      "bio": "League OG, Known fraud, Traded Jonathan Taylor, Thinks his rebuild will work",
      ...
      "valuePosition": "WR", // (optional) Favorite position (QB, WR, RB, TE, etc.)
      "philosophy": "Trade his best player and rebuild, drafting mid players",
      "tradingScale": 8, // 1 - 10
      "preferredContact": "Text", // 'Text', 'WhatsApp', 'Sleeper', 'Email', 'Phone', 'Discord', and 'Carrier Pigeon' are currently supplied in the template
    }
  ]
